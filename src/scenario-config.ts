...
export function loadScenarioConfig(route: string, scenario: string): ScenarioConfig {
  const promptPath = path.join(getProjectRoot(), 'app', route, 'spec', `${scenario}.prompt.md`);
